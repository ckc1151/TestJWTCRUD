...
import com.test.spring.jwtoauth.dtos.requests.ClientsDto;
import com.test.spring.jwtoauth.dtos.responses.AppResponse;
import com.test.spring.jwtoauth.dtos.responses.ErrorResponse;
import com.test.spring.jwtoauth.dtos.responses.LoginSuccessResponse;
import com.test.spring.jwtoauth.dtos.responses.SuccessResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AppResponse> login(@Valid @RequestBody ClientsDto loginRequest, HttpServletRequest request, Principal principal) {
