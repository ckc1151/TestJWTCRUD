package com.test.spring.jwtoauth.service;


import com.test.spring.jwtoauth.entities.AppUser;
import com.test.spring.jwtoauth.repositories.UsersRepository;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // AppUser exists, we have to return an Implementation of UserDetails, let's use the default
